let paths = [
    ...
    "./cdn/utils/errors",
    "./cdn/utils/errors/warn.png",
    "./cdn/utils/errors/error.png",
    "./cdn/utils/errors/info.png",
    "./cdn/utils/roles",
    "./cdn/utils/roles/Duelist.png",
    "./cdn/utils/roles/Controller.png",
    "./cdn/utils/roles/Initiator.png",
    "./cdn/utils/roles/Sentinel.png",
    "./metadata",
    "./metadata/en",
    "./metadata/en/v1",
